...
const navItems = [
  ...
  // FORK(smartlogs): next to Usage because it replaces a tab that used to live there.
  // isActive() uses startsWith, so this entry also stays lit on /dashboard/smart-logs/<id>.
  { href: "/dashboard/smart-logs", label: "Smart Logs", icon: "insights" },
